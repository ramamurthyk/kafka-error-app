...
import app.kafka.mergedemo.reward.Reward;
import app.kafka.mergedemo.reward.RewardProducer;
...
public class Merger extends AbstractConsumerSeekAware {
    ...
    public void onPartitionsAssigned(Map<TopicPartition, Long> assignments, ConsumerSeekCallback callback) {
        ...
        callback.seekRelative(applicationProperties.rewardsConsumerDLT, 0, 0, false);
    }
}
